...
# ============================= DVH properties ============================= #
    ...
    def describe(self):
        ...
        print("Volume[{}]:\t{:0.2f}".format(
            self.volume_units, self.volume))
        print("Max Dose[{}]:\t{:0.2f}".format(
            self.dose_units, self.max))
        print("Min Dose[{}]:\t{:0.2f}".format(
            self.dose_units, self.min))
        print("Mean Dose[{}]:\t{:0.2f}".format(
            self.dose_units, self.mean))
        # print("D100:      {}".format(self.D100))
        print("D98[Gy]:\t{}".format(self.D98))
        print("D90[Gy]:\t{}".format(self.D90))
        print("D50[Gy]:\t{}".format(self.D50))
        # print("D0:       {}".format(self.D0))
        # print("D0:       {}".format(self.D0))
        print("D2cm3[Gy]:\t{}".format(self.D2cc))
        print("D0.1cm3[Gy]:\t{}".format(self.dose_constraint(0.1, 'cc')))
        # if self.notes:
        ...
        print("V14Gy[cm3]:\t{}".format(self.V14Gy))
        print("V7Gy[cm3]:\t{}".format(self.V7Gy))
        print("V100[%]:\t{}".format(self.relative_volume.V100))
        #print("V7Gy[%]:\t{:0.2f} %".format(float(str(self.V7Gy)[0:4])/self.volume*100))
        #if rx_dose != 0:
            #print("RxDose[Gy]:\t{}".format(rx_dose))
            #print("V100[%]:\t{:0.2f}".format(100 * float(str(self.V100)) / round(self.volume, 2)))
    ...
    def statistic(self, name):
        ...
        p = re.compile(r'(\S+)?(D|V|E){1}(\d+[.]?\d*)(gy|cc)?(?!\S+)',
                       re.IGNORECASE)
        ...
        if c[0] == ('v'):
            ...
            if len(c) == 2:
                return self.cumulative.dose_constraint(float(c[1]))
            # Dose Constraints in abs volume (i.e. D2cc) & return a dose
            return self.cumulative.dose_constraint(float(c[1])/10, c[2])
